...
## 📄 範例報告
想先看報告長相 👉 [`reports/_範例報告.txt`](reports/_範例報告.txt)

## 決選股報告欄位
除技術訊號外，決選股自動附上（官方來源）：
- **籌碼**：外資 / 投信 / 三大法人買賣超（張）— TWSE T86 + TPEx openapi
- **基本面**：本益比 PE / 股價淨值比 PB / 殖利率 — TWSE BWIBBU_d + TPEx peratio

## 資料來源
- 全市場代號 + 最新收盤：證交所 STOCK_DAY_ALL + 櫃買 OpenAPI（官方）
- 日線歷史：yfinance，並以官方收盤交叉驗證（誤差 >2% 標警告）
- 籌碼/基本面：證交所、櫃買官方報表（見上）
